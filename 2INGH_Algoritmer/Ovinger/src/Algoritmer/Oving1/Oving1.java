package Algoritmer.Oving1;

/**
 * Created by Roger on 17.08.2015.
 * 
 * 1-1 lag og implementer en algoritme som finner hvilket kj�ps og salgstidspunkt som produserer mest inntjening
 ...
 * 
 * Fasit: kj�p dag 3, selg dag 7
 * 
 * 
 * 
*
 * 1-2: Analyser algoritmen. Finn kompleksiteten for tidsforbruket. Bruk �-notasjon om mulig, eller ihvertfall O-notasjon
 * 
 * 1-3: Legg inn tidsm�ling i programmet, og pr�vekj�r med tallrekker av ulik lengde.
 * 
 * -1, 3, -9, 2, 2, -1, 2, -1, -5
 */
...
public class Oving1 {
	public static void main(String[] args) {
		...
		System.out.println("Kj�pt p� dag nr:  " + res[0]);
		System.out.println("Solgt p� dag nr:  " + res[1]);
		System.out.println("Fortjeneste : " + (res[1] - res[0]));
		System.out.println("Programmet brukte: " + time + " nanosekunder, p� " + laps + " runder");
